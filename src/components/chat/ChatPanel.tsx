...
export function ChatPanel() {
  ...
  return (
    <section className='min-w-[540px] flex-[1] overflow-hidden border-r border-[var(--color-border)] bg-[var(--color-bg-secondary)] max-lg:min-w-0 max-lg:h-[520px] max-lg:w-full max-lg:flex-none max-lg:border-b max-lg:border-r-0'>
      <div className='flex h-full min-h-0 flex-col'>
      <div className='flex h-12 items-center border-b border-[var(--color-border)] bg-[var(--color-bg-secondary)] px-5'>
        <span className='text-sm font-semibold text-[var(--color-text-primary)] tracking-wide'>{t('sessions.current')}</span>
