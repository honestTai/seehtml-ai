...
const zh: Dict = {
  ...
  'chat.placeholderImage': '描述这些图片要怎么处理，留空则自动分析...',
...
const en: Dict = {
  ...
  'chat.title': 'Agent', 'chat.placeholder': 'Type a message, paste images (Ctrl+V), or attach images...',
  'chat.placeholderImage': 'Describe what to do with these images, or leave empty for auto-analysis...',
