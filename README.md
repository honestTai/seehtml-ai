...
**从一个想法，到可预览的 HTML、演示文稿和视频。**  
**From an idea to HTML, presentations, and video.**

[下载桌面版 / Desktop releases](https://github.com/honestTai/seehtml-ai/releases) · [GitHub](https://github.com/honestTai/seehtml-ai) · [HRouter](https://hrouter.net/home)

</div>

在本地项目中描述需求，让 AI 生成或修改 HTML，边预览边调整，再导出 PPTX、MP4 或图片。

Describe what you need in a local project, create or refine HTML with AI, preview the result, and export to PPTX, MP4, or images.

**适合谁 / Who it’s for**  
需要制作演示、动画与可视化内容的创作者和开发者。  
Creators and developers building presentations, animations, and visual content.
